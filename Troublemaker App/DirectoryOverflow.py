...
class DirectoryOverflow(Event):
    def __init__(self, intensity, occurence):
        super().__init__(intensity, occurence)

    def triggerEvent(self):
        self.simulate_directory_overflow("./overflow_test_dir", 1000, 1)

    def generate_random_file(self, filepath, size_kb=1):
    ...
    def simulate_directory_overflow(self, directory, num_files=1000, size_kb=1):
        ...
        for i in range(num_files):
            ...
            try:
                self.generate_random_file(filename, size_kb)
                created_files += 1
